...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  useEffect(() => {
    ...
    const activeAnchor = navRef.current.querySelectorAll('a')[activeIndex] as HTMLElement;
    if (activeAnchor) {
    ...
    const resizeObserver = new ResizeObserver(() => {
      const currentActiveAnchor = navRef.current?.querySelectorAll('a')[activeIndex] as HTMLElement;
      if (currentActiveAnchor) {
        updateEffectPosition(currentActiveAnchor);
      }
    });
